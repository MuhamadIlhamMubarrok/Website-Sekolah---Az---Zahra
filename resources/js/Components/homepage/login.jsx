            ...
            <div className="w-full max-w-md space-y-8">
                <div>
                    <img
                        ...
                        alt="Your Company"
                    />
                    <h2 className="mt-6 text-center text-3xl font-bold kuy">
                    ...
                    <div className="-space-y-px rounded-md shadow-sm">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                required
                                className="relative block w-full input input-accent input-bordered rounded-t-md px-3 py-2 text-gray-900 focus:z-10 focus:border-[#439A97]  focus:ring-[#439A97] sm:text-sm mt-2"
